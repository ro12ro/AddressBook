    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn default dropdown-toggle" + size + "' data-toggle='dropdown' href='javascript:;'>" +
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "<div class='modal-footer'>" +
                  "<a href='javascript:;' class='btn default' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
                  "<a href='javascript:;' class='btn btn-primary' data-dismiss='modal'>" + locale.link.insert + "</a>" +
                "</div>" +
              "</div>" +
               ($.fn.modalmanager ? "" : "</div>") +
              "</div>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "</div>" +
                "<div class='modal-footer'>" +
                  "<a href='javascript:;' class='btn default' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
                  "<a href='javascript:;' class='btn btn-primary' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                "</div>" +
              "</div>" +
               ($.fn.modalmanager ? "" : "</div>") +
              "</div>" +
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li class='dropdown'>" +
              "<a class='btn default dropdown-toggle" + size + "' data-toggle='dropdown' href='javascript:;' tabindex='-1'>" +
